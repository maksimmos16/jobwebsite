...
<form id="candidate-profile" method="post" enctype="multipart/form-data" autocomplete="off">
    ...
    <div class="main-body">
        ...
        <h2>Lets start to create your CV </h2>
        <h4>If you have CV you can upload it below</h4>
    ...
    <div class="dashboard-edit-profile">
        ...
        <form id="change_password" method="post" enctype="multipart/form-data">
            <div class="row">
				...
				<p>del acc email</p>
				<input type="text" placeholder="If you want to delete your account please enter your Email" value="" name="email_pass_video" class="form-control email-pass-delete">
