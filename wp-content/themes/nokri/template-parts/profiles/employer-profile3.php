...
<section class="n-candidate-detail light-blue">
    <div class="container">
        <div class="row">
            <div class="col-lg-10 col-sm-12 col-md-12 col-xs-12 col-lg-offset-1">
                            ...
                            <?php if ($emp_profile_status == 'pub' || $author_id == $current_user_id) { ?>
                                <?php if ($emp_profile_status == 'pub') { ?>                        
                                    <div class="n-details-box-text">
                                        <a href="javascript:void(0)"><h3><?php echo the_author_meta('display_name', $user_id); ?></h3></a>
                                        <?php
                    ...
                    <div class="n-employers-details-w">
                        <?php if ($emp_profile_status == 'pub' || $author_id == $current_user_id) { ?>
                            <ul class="nav nav-tabs">
                                <li class="active"><a data-toggle="tab" href="#home"><?php echo esc_html__('All Details','nokri'); ?></a></li>
                                <li><a data-toggle="tab" href="#menu1"><?php echo esc_html__('All Jobs','nokri'); ?></a></li>
                                <li><a data-toggle="tab" href="#menu2"><?php echo esc_attr__('Ratings & Reviews', 'nokri'); ?></a></li>   
                            </ul>
                                            ...
                                            <ul>
                                                <li>
                                                    ...
                                                    <div class="n-list-employ-text">                                                          
                                                        ...
                                                        <p><strong><?php echo date_i18n(get_option('date_format'), strtotime($registered)); ?></strong></p>
                                                    </div>
                                                </li>
                                                <?php if ($emp_address) { ?>
                                                    <li>
