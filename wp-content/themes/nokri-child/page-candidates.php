                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            ...
                            <aside class="new-sidebar">
                                ...
                                <div class="heading">
                                    <h4 class="show-candidate-search">Show candidate search</h4> 
                                </div>   
                                <div class="heading">
                                ...
                                <div class="panel-group search-candidate-display-none" id="accordion" role="tablist" aria-multiselectable="true">
                                     <?php echo get_sidebar('candidates'); ?>
                                </div>
                            </aside>
							<aside class="new-sidebar">
                                <?php dynamic_sidebar( 'ads_widgets' ); ?>
                            </aside>  
                        </div>
