...
<form id="candidate-profile" method="post" enctype="multipart/form-data" autocomplete="off">
    ...
    <div class="main-body">
        ...
        <h2>Lets start to create your VC </h2>
        <h4>If you have VC you can upload it below</h4>
    ...
    <div class="dashboard-edit-profile">
        ...
        <form id="change_password" method="post" enctype="multipart/form-data">
            <div class="row">
                ...
                <div class="col-md-12 col-xs-12 col-sm-12">
					<p>If you want to delete your account please enter your Email</p>
                    ...
                    <?php if ($is_acount_del) { ?>
                        <input type="button" value="<?php echo esc_html__('Delete account?', 'nokri'); ?>" class="hide_del_button btn btn-custom del_acount"><?php } ?>
...
jQuery(document).ready(function(){
	$(document).on("click", ".btn", offBeforeUnload);
