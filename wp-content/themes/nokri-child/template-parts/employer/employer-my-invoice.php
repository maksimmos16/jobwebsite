...
<div class="main-body">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="btn n-btn-flat pull-right get-invoice"><?php echo do_shortcode('[wcpdf_download_invoice link_text="Get Invoice" order_id="'.$_GET['order_id'].'"]'); ?></div>
  </div>
</div>
<script>
    ...
    jQuery(".get-invoice p").first().contents().unwrap();
  });
</script>